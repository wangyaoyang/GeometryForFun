================================================================================
    MICROSOFT 基础类库： GeometryForFun 项目概述
===============================================================================

应用程序向导已为您创建了此 GeometryForFun 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 GeometryForFun 应用程序的每个文件的内容摘要。

GeometryForFun.vcproj
...
GeometryForFun.h
    ...
    CGeometryForFunApp 应用程序类。

GeometryForFun.cpp
    这是包含应用程序
    类 CGeometryForFunApp 的主应用程序源文件。
...
res\GeometryForFun.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 GeometryForFun.rc 中。

res\GeometryForFun.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 GeometryForFun.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
GeometryForFunDoc.h、GeometryForFunDoc.cpp - 文档
    这些文件包含 CGeometryForFunDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CGeometryForFunDoc::Serialize）。
GeometryForFunView.h、GeometryForFunView.cpp - 文档视图
    这些文件包含 CGeometryForFunView 类。
    CGeometryForFunView 对象用于查看 CGeometryForFunDoc 对象。
res\GeometryForFunDoc.ico
    这是一个图标文件，用作 
    CGeometryForFunDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 GeometryForFun.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 GeometryForFun.pch 的预编译头文件 (PCH)
